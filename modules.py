...
# For Keras style summary(model, enc_inputs=[x,t])
...
class Down(nn.Module):
    def __init__(self, in_channels, out_channels, emb_dim=256):
        ...
        # This will take time embedding (of dimension 256) and give output of dimension "out_channels"
...
class UNet(nn.Module):
    ...
    def forward(self, x, t):
        ...
        x3 = self.down2(x2, t)  # x3: It has timestep positional encoding in it
        x3 = self.sa2(x3)       #     It will use this x3 at the decoder (self-attention output)
        x4 = self.down3(x3, t)
        x4 = self.sa3(x4)
